...
This section provides documentation related to the https://www.exoscale.com/dbaas/kafka/[Exoscale DBaaS Managed OpenSearch^] service in the VSHN Application Catalog.
