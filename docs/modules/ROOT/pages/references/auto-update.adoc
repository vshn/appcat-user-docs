...
[NOTE]
====
The auto-update feature is enabled once the next maintenance window is finished. If the feature is required immediately, the maintenance can be manually triggered. 
====
