...
[NOTE]
====
The auto-update feature is enabled once the next maintenance window is finished. If the feature is required asap, the maintenance can be manually triggered. 
====
