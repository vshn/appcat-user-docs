...
.Resource Types
- xref:{anchor_prefix}-github-com-vshn-component-appcat-apis-vshn-v1-xvshnpostgresql[$$XVSHNPostgreSQL$$]
...
- xref:{anchor_prefix}-github-com-vshn-component-appcat-apis-vshn-v1-xvshnpostgresql[$$XVSHNPostgreSQL$$]
- xref:{anchor_prefix}-github-com-vshn-component-appcat-apis-vshn-v1-xvshnpostgresqllist[$$XVSHNPostgreSQLList$$]
...
| *`items`* __xref:{anchor_prefix}-github-com-vshn-component-appcat-apis-vshn-v1-xvshnpostgresql[$$XVSHNPostgreSQL$$] array__ | 
|===
...
| *`updateStrategy`* __xref:{anchor_prefix}-github-com-vshn-component-appcat-apis-vshn-v1-vshnpostgresqlupdatestrategy[$$VSHNPostgreSQLUpdateStrategy$$]__ | UpdateStrategy indicates how and when updates to the instance spec will be applied.
|===
...
[id="{anchor_prefix}-github-com-vshn-component-appcat-apis-vshn-v1-vshnpostgresqlupdatestrategy"]
...
[id="{anchor_prefix}-github-com-vshn-component-appcat-apis-vshn-v1-xvshnpostgresql"]
=== XVSHNPostgreSQL 
...
[id="{anchor_prefix}-github-com-vshn-component-appcat-apis-vshn-v1-xvshnpostgresqllist"]
=== XVSHNPostgreSQLList 
