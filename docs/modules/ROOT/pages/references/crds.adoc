...
.Packages
- xref:{anchor_prefix}-appcat-vshn-io-v1[$$exoscale.appcat.vshn.io/v1$$]
- xref:{anchor_prefix}-appcat-vshn-io-v1[$$vshn.appcat.vshn.io/v1$$]
...
.Resource Types
- xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-postgresql[$$VSHNPostgreSQL$$]
...
|===
| Field | Description
| *`apiVersion`* __string__ | `exoscale.exoscale.appcat.vshn.io/v1`
...
// VSHN Postgresql section start
// xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-postgresql[$$VSHNPostgreSQL$$]
[id="{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-postgresql"]
=== VSHNPostgreSQL 

VSHNPostgreSQL is the API for creating VSHN managed PostgreSQL instances.
...
| *`spec`* __xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-postgresql-spec[$$VSHNPostgreSQLSpec$$]__ | 
|===

[id="{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-postgresql-spec"]
=== VSHNPostgreSQLSpec 


.Appears In:
****
- xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-postgresql[$$ExoscalePostgreSQL$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`parameters`* __xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-postgresql-parameters[$$VSHNPostgreSQLParameters$$]__ | Parameters are the configurable fields of a ExoscalePostgreSQL.
|===
...
.Appears In:
****
- xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-postgresql-spec[$$VSHNPostgreSQLSpec$$]
****

[cols="25a,75a", options="header"]
|===
| Field | Description
| *`service`* __xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-postgresql-service-spec[$$VSHNPostgreSQLServiceSpec$$]__ | Service contains VSHN PostgreSQL DBaaS specific properties
| *`maintenance`* __xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-dbaas-maintenance-schedule-spec[$$VSHNDBaaSMaintenanceScheduleSpec$$]__ | Maintenance contains settings to control the maintenance of an instance.
| *`size`* __xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-dbaas-size-spec[$$VSHNDBaaSSizeSpec$$]__ | Size contains settings to control the sizing of a service.
| *`network`* __xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-dbaas-network-spec[$$VSHNDBaaSNetworkSpec$$]__ | Network contains any network related settings.
| *`backup`* __xref:{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-dbaas-backup-spec[$$VSHNPostgreSQLBackup$$]__ | Backup contains settings to control the backups of an instance.
|===


[id="{anchor_prefix}-github-com-vshn-component-appcat-v1-vshn-postgresql-service-spec"]
=== ExoscalePostgreSQLServiceSpec 
