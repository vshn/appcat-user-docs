...
AppCat allows DevOps engineers to quickly provision S3 buckets in various environments.

IMPORTANT: In its first release, AppCat S3 buckets are only available on the https://portal.appuio.cloud/zones/cloudscale-lpg-2[cloudscale.ch LPG 2 region] of APPUiO Cloud.
