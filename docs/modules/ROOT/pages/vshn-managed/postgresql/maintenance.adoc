...
For more information what the security maintenance entails, please visit https://products.docs.vshn.ch/products/appcat/postgresql.html#_recurring_maintenance[the product description].
