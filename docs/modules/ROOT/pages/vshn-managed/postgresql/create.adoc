...
NOTE: Please be aware that the normal https://docs.appuio.cloud/user/explanation/fair-use-policy.html[Fair Use Policy] applies to AppCat Services by VSHN as well.
