...
Deployments based on CloudNativePG (CNPG for short) are the new default. If you already have any StackGres based instances, we advise you to migrate away immediately. Do so by following the https://docs.appcat.ch/vshn-managed/postgresql/migration.html[migration guide].
