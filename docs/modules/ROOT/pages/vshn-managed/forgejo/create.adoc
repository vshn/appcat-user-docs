...
<5> Forgejo version - link:https://products.vshn.ch/appcat/forgejo.html#_supported_versions[Supported Versions]
...
This is relevant for stuff like webhook notifications, OAuth etc.
