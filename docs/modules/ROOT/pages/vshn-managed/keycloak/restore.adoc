...
====
Restorations can be initiated only from an instance in the same namespace.
Make sure to restore before deleting the old instance. If an instance is deleted, the backups are deleted as well.
====
