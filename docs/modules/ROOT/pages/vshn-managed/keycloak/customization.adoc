...
The old `customizationImage` approach copies files at runtime via init containers and is incompatible with optimized startup, this solution will be deprecated in the future.
