...
All new MariaDB instances will be created with default collation `utf8mb4_unicode_ci`, see https://docs.appcat.ch/vshn-managed/mariadb/create.html[Create MariaDB].
...
== Changes affecting instance sizing
