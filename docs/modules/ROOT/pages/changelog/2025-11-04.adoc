...
== PostgreSQL CNPG Scaling

PostgreSQL with CNPG can be replicated. You can try it out by setting the number of instances to 2 or 3. For more details, refer to https://docs.appcat.ch/vshn-managed/postgresql/replicas.html[PostgreSQL replication].
