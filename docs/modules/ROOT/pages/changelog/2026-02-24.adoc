...
We have switched the PostgreSQL database used for VSHN AppCat Keycloak service from StackGres to CloudNativePG. It does not affect the existing Keycloak instances. 
