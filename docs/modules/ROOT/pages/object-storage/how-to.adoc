...
{product} allows DevOps engineers to quickly provision S3-compatible Object Storage Buckets in various environments.

IMPORTANT: In its first release, {product} Object Storage buckets are only available on the https://portal.appuio.cloud/zones/cloudscale-lpg-2[cloudscale.ch LPG 2 region] of APPUiO Cloud.
